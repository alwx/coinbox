...
var or__27261__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj35151 = {"detail":data};
return obj35151;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27249__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27249__auto__)){
var and__27249__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__35158 = cljs.core._EQ_;
var expr__35159 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35158.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35159))){
return ((function (pred__35158,expr__35159){
return (function (p1__35152_SHARP_){
return console.warn(p1__35152_SHARP_);
});
;})(pred__35158,expr__35159))
} else {
if(cljs.core.truth_(pred__35158.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35159))){
return ((function (pred__35158,expr__35159){
return (function (p1__35153_SHARP_){
return console.debug(p1__35153_SHARP_);
});
;})(pred__35158,expr__35159))
} else {
if(cljs.core.truth_(pred__35158.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35159))){
return ((function (pred__35158,expr__35159){
return (function (p1__35154_SHARP_){
return console.error(p1__35154_SHARP_);
});
;})(pred__35158,expr__35159))
} else {
return ((function (pred__35158,expr__35159){
return (function (p1__35155_SHARP_){
return console.log(p1__35155_SHARP_);
});
;})(pred__35158,expr__35159))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35162){
...
var opts = map__35163__$1;
var eval_fn = cljs.core.get.call(null,map__35163__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35165_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35167,(0),null);
...
if(cljs.core.truth_((function (){var and__27249__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1511532878169
