...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__28908){
var vec__28909 = p__28908;
var _ = cljs.core.nth.call(null,vec__28909,(0),null);
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__28912_SHARP_){
return ((p1__28912_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__28912_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__28913,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__28913;
}
});
...
var len__28432__auto___28916 = arguments.length;
var i__28433__auto___28917 = (0);
while(true){
if((i__28433__auto___28917 < len__28432__auto___28916)){
args__28439__auto__.push((arguments[i__28433__auto___28917]));

var G__28918 = (i__28433__auto___28917 + (1));
i__28433__auto___28917 = G__28918;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__28440__auto__);
});
...
var G__28915 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__28915,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__28915;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq28914){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28914));
});
...
var vec__28921 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__28921,(0),null);
var names = cljs.core.nth.call(null,vec__28921,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__28921,tag_name,names){
return (function (p1__28919_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__28919_SHARP_))){
return p1__28919_SHARP_;
} else {
return null;
}
});})(matches,vec__28921,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__28921,tag_name,names){
return (function (p1__28920_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__28920_SHARP_));
});})(matches,vec__28921,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__28924){
var vec__28925 = p__28924;
var seq__28926 = cljs.core.seq.call(null,vec__28925);
var first__28927 = cljs.core.first.call(null,seq__28926);
var seq__28926__$1 = cljs.core.next.call(null,seq__28926);
var tag = first__28927;
var content = seq__28926__$1;
...
var vec__28928 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__28928,(0),null);
var id = cljs.core.nth.call(null,vec__28928,(1),null);
var class$ = cljs.core.nth.call(null,vec__28928,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1511532868131
