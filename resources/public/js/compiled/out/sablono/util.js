...
var x__27944__auto__ = (((x == null))?null:x);
var m__27945__auto__ = (sablono.util.to_str[goog.typeOf(x__27944__auto__)]);
if(!((m__27945__auto__ == null))){
return m__27945__auto__.call(null,x);
} else {
var m__27945__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__27945__auto____$1 == null))){
return m__27945__auto____$1.call(null,x);
} else {
...
var x__27944__auto__ = (((x == null))?null:x);
var m__27945__auto__ = (sablono.util.to_uri[goog.typeOf(x__27944__auto__)]);
if(!((m__27945__auto__ == null))){
return m__27945__auto__.call(null,x);
} else {
var m__27945__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__27945__auto____$1 == null))){
return m__27945__auto____$1.call(null,x);
} else {
...
var len__28432__auto___28895 = arguments.length;
var i__28433__auto___28896 = (0);
while(true){
if((i__28433__auto___28896 < len__28432__auto___28895)){
args__28439__auto__.push((arguments[i__28433__auto___28896]));

var G__28897 = (i__28433__auto___28896 + (1));
i__28433__auto___28896 = G__28897;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__28440__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq28894){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28894));
});
...
var vec__28898 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__28900;
var words = seq__28899__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__28901){
...
return cljs.core.update.call(null,G__28905,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__28905;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__27261__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1511532868002
